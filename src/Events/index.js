...
const eventHandlers = {
  ...
  guildMemberBan: require('./guildMemberBan'),
  guildMemberUnban: require('./guildMemberUnban'),
...
class Events {
  constructor (client) {
    ...
    this.client.on('guildBanAdd', eventHandlers.guildMemberBan)
    this.client.on('guildBanRemove', eventHandlers.guildMemberUnban)
